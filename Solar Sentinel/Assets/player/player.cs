...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float movimentoHorizontal = Input.GetAxis("Vertical");
        float movimentoVertical = Input.GetAxis("Horizontal");
